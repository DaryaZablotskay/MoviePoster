...
{
    public partial class SeedFDataNew2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Places",
                columns: new[] { "PlaceId", "Hall", "RowNumber", "SeatNumber" },
                values: new object[,]
                {
                    { new Guid("bb03b2c7-ca1a-4bfa-bced-a398b9dab90f"), 1, 1, 1 },
                    { new Guid("24c523fc-7f04-40b2-9496-25d085de0584"), 1, 1, 2 },
                    { new Guid("b44283ae-a373-4365-b424-7cf6c6e460cd"), 1, 2, 1 },
                    { new Guid("9e28f3da-c04d-4779-8541-f58dbf0dabe9"), 1, 2, 2 },
                    { new Guid("23a7b943-5e4c-4304-a3ab-1cda0f58a2a0"), 2, 1, 1 },
                    { new Guid("e34e7df7-31e1-422e-afb9-a7602c18567b"), 2, 2, 1 }
                });
